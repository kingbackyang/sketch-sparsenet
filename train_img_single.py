...
from sketch_core import builder
from sketch_core.callbacks import MeanIoU
from sketch_core.img_trainers import SketchImageTrainer
...
def main() -> None:
    ...
    # ckpt = torch.load("mbv3_benchmark/mbv3_merge_ndataset/checkpoints/max-top1 acc.pt")
    ...
    trainer = SketchImageTrainer(model=model,
                           criterion=criterion,
                           optimizer=optimizer,
                           scheduler=scheduler,
                           num_workers=configs.workers_per_gpu,
